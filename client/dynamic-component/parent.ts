...
import { Component, OnInit, DynamicComponentLoader, ViewContainerRef, ComponentRef, ElementRef } from 'angular2/core';
...
export class DynamicComponentDemo implements OnInit {
    ...
    loaderAction() {
        ...
        let child = this.loader.loadNextToLocation(ChildComponent, this.vcRef.element)
